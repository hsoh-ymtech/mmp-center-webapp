...
curl -X PUT "http://${ELASTIC_HOST}:${ELASTIC_PORT}/twamp"

curl -X PUT -H "Content-Type: application/json" -H "Accept: application/json" -d "@mapping_table.json" "http://${ELASTIC_HOST}:${ELASTIC_PORT}/twamp/measurement/_mapping"

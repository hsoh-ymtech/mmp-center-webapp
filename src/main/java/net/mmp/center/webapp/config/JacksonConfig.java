package net.mmp.center.webapp.config;
...
/**
 * LocalDateTime 데이터 포맷 변경 (yyyy/MM/dd kk:mm:ss)
    ...
    public Module jsonMapperJava8DateTimeModule() {
        ...
        module.addDeserializer(LocalTime.class, new JsonDeserializer<LocalTime>() {
            ...
            public LocalTime deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
                return LocalTime.parse(jsonParser.getValueAsString(), DateTimeFormatter.ofPattern("kk:mm:ss.SSS"));
            }
        });
        module.addDeserializer(LocalDateTime.class, new JsonDeserializer<LocalDateTime>() {
            @Override
            public LocalDateTime deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
                return LocalDateTime.parse(jsonParser.getValueAsString(), DateTimeFormatter.ofPattern("yyyy-MM-dd kk:mm:ss.SSS"));
            }
        });
        ...
        module.addSerializer(LocalTime.class, new JsonSerializer<LocalTime>() {
            ...
            public void serialize(
                    ...
                    throws IOException {
                jsonGenerator.writeString(DateTimeFormatter.ofPattern("kk:mm:ss.SSS").format(localTime));
            }
        });
        module.addSerializer(LocalDateTime.class, new JsonSerializer<LocalDateTime>() {
            ...
            public void serialize(
                    ...
                    throws IOException {
                jsonGenerator.writeString(DateTimeFormatter.ofPattern("yyyy-MM-dd kk:mm:ss.SSS").format(localDateTime));
            }
        });

...
import net.mmp.center.webapp.CenterWebappApplication;
...
public class Util {
	...
	public static String convertDirectory(String directory) {
		...
		try {
			jarLocationUrl = CenterWebappApplication.class.getProtectionDomain().getCodeSource().getLocation().getPath().toString();
